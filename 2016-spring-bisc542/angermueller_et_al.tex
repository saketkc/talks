...
\begin{frame}[fragile]
	\Large Association between expression levels and methylation : BOTH negative and positive $\implies$ Interactions are Complex!
\end{frame}

\begin{frame}
	Correlation coefficients in alternative genomic context:
	\vspace*{-10pt}
	\begin{center}
